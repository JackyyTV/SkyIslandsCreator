...
public class CommonProxy {
    ...
    private static void convert() throws IOException, ClassNotFoundException {
        ...
        FileUtils.writeStringToFile(newFile, s, (Charset) null);
        outputStream.close();
        oldIslands.delete();
    ...
    public static void saveIslands(HashMap<String, IslandCreator.IslandPos> map) throws IOException {
        String s = new GsonBuilder().create().toJson(map);
        FileUtils.writeStringToFile(islands, s, (Charset) null);
    }
    ...
    public static HashMap<String, IslandCreator.IslandPos> getIslands() throws IOException {
        ...
        HashMap<String, IslandCreator.IslandPos> map = new Gson().fromJson(FileUtils.readFileToString(islands, (Charset) null), new TypeToken<HashMap<String, IslandCreator.IslandPos>>(){}.getType());
        stream.close();
        return map;
    }
